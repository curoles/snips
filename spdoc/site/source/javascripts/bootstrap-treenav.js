...
$(function() {
  ...
  $.fn.navTree = function(options) {
    ...
    var defaults = {
      navTreeExpanded: 'fa fa-minus-square-o',// 'icon-collapse-alt',
      navTreeCollapsed: 'fa fa-plus-square-o' //'icon-expand-alt'
    };
  ...
  $("ul[data-toggle='nav-tree']").each(function(){
    window.console && console.log('next ul[data-toggle=nav-tree]');
    var $tree;
    $tree = $(this);
